...
function ju_enqueue(){
	...
	// RTL
	wp_register_style( 'ju_bootstrap_rtl' , get_template_directory_uri() . '/assets/css/bootstrap-rtl.css' );
	wp_register_style( 'ju_style_rtl' , get_template_directory_uri() . '/assets/style-rtl.css' );
	wp_register_style( 'ju_dark_rtl', get_template_directory_uri() . '/assets/css/dark-rtl.css' );
	wp_register_style( 'ju_font_icons_rtl', get_template_directory_uri() . '/assets/css/font-icons-rtl.css' );
	wp_register_style( 'ju_responsive_rtl', get_template_directory_uri() . '/assets/css/responsive-rtl.css' );
